import{S as N}from"./atlas_BquwSblcWUB4t1X9mJVXg.js";import{a as H,D as U}from"./atlas_CsNlpTJ6NsQp-ssMKmb0h.js";import{c as E,G as A,V as m,e as C,D as V,i as D,d as z,n as L,B as O,F as b}from"./atlas_kKpPRC9Ko2x1xhYFTYWg4.js";const r={PATCH_COUNT:{min:20,max:40},DENSITY:{min:.8,max:1.5},SIZE:{min:.08,max:.25},OPACITY:{min:.7,max:.95},TREE_HEIGHT:{min:.015,max:.035},TIME_SPEED:{min:.05,max:.2}};class M{vegetationGroup;vegetationPatches=[];treeLayers=[];params;cosmicOriginTime;cosmicOffset;static vegetationVertexShader=`
