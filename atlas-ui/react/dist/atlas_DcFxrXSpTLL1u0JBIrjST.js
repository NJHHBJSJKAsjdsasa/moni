import{S as C}from"./atlas_BquwSblcWUB4t1X9mJVXg.js";import{a as _}from"./atlas_CsNlpTJ6NsQp-ssMKmb0h.js";import{G as z,m as L,V as u,n as V,a as A,d as Y,e as R,o as B,i as W}from"./atlas_kKpPRC9Ko2x1xhYFTYWg4.js";const o={CLOUD_COUNT:{min:15,max:25},SIZE:{min:3.8,max:5.5},OPACITY:{min:.4,max:.8},DENSITY:{min:.5,max:1.5},ROTATION_SPEED:{min:.002,max:.008},MOVEMENT_AMPLITUDE:{min:.003,max:.02},TURBULENCE:{min:1,max:2},TIME_SPEED:{min:.1,max:3}};class E{cloudSystem;material;params;cloudCount;clouds=[];cosmicOriginTime;cosmicOffset;static vertexShader=`
