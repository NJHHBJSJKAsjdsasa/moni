import{S as C}from"./atlas_CyINvvA9z94U_VTNKIak4.js";import{a as _}from"./atlas_Bc7tCBLUzA7hEBl0iO9qx.js";import{cp as z,aJ as L,V as u,M as V,o as A,m as Y,au as R,g as B,bA as W}from"./atlas_CvLHNd-mv9CFAycOCNrF6.js";const o={CLOUD_COUNT:{min:15,max:25},SIZE:{min:3.8,max:5.5},OPACITY:{min:.4,max:.8},DENSITY:{min:.5,max:1.5},ROTATION_SPEED:{min:.002,max:.008},MOVEMENT_AMPLITUDE:{min:.003,max:.02},TURBULENCE:{min:1,max:2},TIME_SPEED:{min:.1,max:3}};class E{cloudSystem;material;params;cloudCount;clouds=[];cosmicOriginTime;cosmicOffset;static vertexShader=`
