import{S as b}from"./atlas_CGEzHqiP6UrmR4JlMl8bd.js";import{a as F,D as N}from"./atlas_Be-3E54fbq6i1G6LOfhmR.js";import{C as n,cp as W,V as r,aJ as _,M as G,m as H,au as O,g as U,bE as z,cv as k}from"./atlas_BkM-4aqZ6cV-vWVlt631_.js";const t={FLOW_COUNT:{min:20,max:35},FLOW_LENGTH:{min:.4,max:1.2},FLOW_WIDTH:{min:.015,max:.08},FLOW_INTENSITY:{min:1.5,max:3},FLOW_SPEED:{min:.05,max:.3},PULSE_SPEED:{min:.5,max:1.2},TURBULENCE:{min:.8,max:2},EMISSIVE_INTENSITY:{min:3,max:5},GLOW_RADIUS:{min:1.1,max:1.3},TIME_SPEED:{min:.1,max:2},EMERGENCE_HEIGHT:{min:.01,max:.03}};class d{lavaGroup;lavaFlows=[];material;params;startTime;static vertexShader=`
