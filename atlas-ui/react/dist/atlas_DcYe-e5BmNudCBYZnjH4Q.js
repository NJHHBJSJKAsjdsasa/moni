import{S as C}from"./atlas_CGEzHqiP6UrmR4JlMl8bd.js";import{a as Y,D as k}from"./atlas_Be-3E54fbq6i1G6LOfhmR.js";import{cp as T,V as s,cr as J,au as W,C as q,m as Q}from"./atlas_BkM-4aqZ6cV-vWVlt631_.js";const i={ERUPTION_INTENSITY:{min:.5,max:1.5},ERUPTION_FREQUENCY:{min:3,max:8},PROJECTILE_COUNT:{min:3,max:8},PROJECTILE_SIZE:{min:.001,max:.004},ARC_HEIGHT:{min:.01,max:.04},FLARE_LENGTH:{min:.08,max:.25},TIME_SPEED:{min:.8,max:1.2}};class I{eruptionsGroup;projectilesGroup;trailsGroup;splashGroup;eruptionPatterns=[];params;planetRadius;cosmicOriginTime;cosmicOffset;rng;projectilePool=[];trailPool=[];splashPool=[];static projectileVertexShader=`
