import{S as p}from"./atlas_CyINvvA9z94U_VTNKIak4.js";import{g as P,D as T}from"./atlas_Bc7tCBLUzA7hEBl0iO9qx.js";import{i as y,co as d,av as n,au as C,bE as A}from"./atlas_CvLHNd-mv9CFAycOCNrF6.js";const t={PARTICLE_COUNT:{min:60,max:150},PHASE_INTENSITY:{min:.4,max:.9},TRANSITION_SPEED:{min:1,max:4},COHERENCE_LEVEL:{min:.7,max:.7},TIME_SPEED:{min:3e-4,max:6e-4},PHASE_STATES:{min:3,max:6}};class l{phaseSystem;material;geometry;params;particleCount;startTime;static vertexShader=`
