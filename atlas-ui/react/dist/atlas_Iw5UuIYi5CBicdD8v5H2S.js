import{S as C}from"./atlas_BquwSblcWUB4t1X9mJVXg.js";import{a as k,D as Y}from"./atlas_CsNlpTJ6NsQp-ssMKmb0h.js";import{G as T,V as s,k as J,e as W,c as q,d as Q}from"./atlas_kKpPRC9Ko2x1xhYFTYWg4.js";const i={ERUPTION_INTENSITY:{min:.5,max:1.5},ERUPTION_FREQUENCY:{min:3,max:8},PROJECTILE_COUNT:{min:3,max:8},PROJECTILE_SIZE:{min:.001,max:.004},ARC_HEIGHT:{min:.01,max:.04},FLARE_LENGTH:{min:.08,max:.25},TIME_SPEED:{min:.8,max:1.2}};class I{eruptionsGroup;projectilesGroup;trailsGroup;splashGroup;eruptionPatterns=[];params;planetRadius;cosmicOriginTime;cosmicOffset;rng;projectilePool=[];trailPool=[];splashPool=[];static projectileVertexShader=`
