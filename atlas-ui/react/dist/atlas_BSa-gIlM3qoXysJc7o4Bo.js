import{D as T,g as P}from"./atlas_Be-3E54fbq6i1G6LOfhmR.js";import{S as v}from"./atlas_CGEzHqiP6UrmR4JlMl8bd.js";import{cp as M,C as _,aJ as C,V as g,m as A,au as I,D as O,bE as R}from"./atlas_BkM-4aqZ6cV-vWVlt631_.js";const s={OBJECT_COUNT:{min:16,max:32},SPOT_SIZE:{min:.4,max:1.2},SPOT_SIZE_SPECIAL:{min:3.2,max:4.2},MOVE_SPEED:{min:.01,max:.1},INNER_ROTATION_SPEED:{min:-300,max:300},PULSE_AMPLITUDE:{min:.1,max:2.5},TIME_SPEED:{min:.1,max:3}},y=.04;function D(u,i,e){return new I({uniforms:{uTime:{value:0},uToxicColor:{value:u},uSize:{value:i},uSeed:{value:e},uPulseAmplitude:{value:.2}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
