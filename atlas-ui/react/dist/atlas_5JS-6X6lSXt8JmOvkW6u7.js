import{E as T,R as S,U as A,S as v}from"./atlas_C3oRvbmwue_4SQjb8qMBt.js";import{g as I,D as C}from"./atlas_CsNlpTJ6NsQp-ssMKmb0h.js";import{S as b}from"./atlas_BquwSblcWUB4t1X9mJVXg.js";import{c as f,a as d}from"./atlas_kKpPRC9Ko2x1xhYFTYWg4.js";const o={bloomStrength:{min:.3,max:.6},bloomRadius:{min:.4,max:.8},bloomThreshold:{min:.2,max:.5},godrayIntensity:{min:.05,max:.16},chromaticAberrationIntensity:{min:.001,max:.004},timeSpeed:{min:.6,max:1.8},breathingAmplitude:{min:.05,max:.2},pulseAmplitude:{min:.02,max:.1}},D={uniforms:{tDiffuse:{value:null},uIntensity:{value:.005},uToxicTint:{value:new f(.5,0,.8)},uTime:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
